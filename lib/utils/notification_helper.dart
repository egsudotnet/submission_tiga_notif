...
class NotificationHelper {
  ...
  Future<void> showNotification(
     ...
     RestaurantDetailResult restaurantDetail) async {
    var channelId = "1";
    var channelName = "channel_01";
    var channelDescription = "Favorite Restaurant";  
    ...
    var title = restaurantDetail.restaurant.name;
  ...
  void configureSelectNotificationSubject(String route) {
    selectNotificationSubject.stream.listen(
      (String payload) async {
        var decodeJson = json.decode(payload);
        var data = RestaurantDetailResult.fromJson(decodeJson);
